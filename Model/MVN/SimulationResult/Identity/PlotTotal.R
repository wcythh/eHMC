...
for(k in 1:8)
{
  ...
  FitTemp <- get(load(file=paste("Identity/Result/",toString(Ind[k]),"/Result.RData",sep="")))
  for(m in 1:40)
  {
    val <- FitTemp[[m]]
    MetricNUTS[[k]][m,] <- c(min(val$NUTS_Summary$statistics$ess_by_mcmcse[1:100])/val$NUTS_Summary$Comp,
                             mean(val$NUTS_Summary$statistics$ess_by_mcmcse[1:100])/val$NUTS_Summary$Comp,
                             median(val$NUTS_Summary$statistics$ess_by_mcmcse[1:100])/val$NUTS_Summary$Comp,
                             max(val$NUTS_Summary$statistics$ess_by_mcmcse[1:100])/val$NUTS_Summary$Comp,
                             min(val$NUTS_Summary$statistics$ess_by_coda[1:100])/val$NUTS_Summary$Comp,
                             mean(val$NUTS_Summary$statistics$ess_by_coda[1:100])/val$NUTS_Summary$Comp,
                             median(val$NUTS_Summary$statistics$ess_by_coda[1:100])/val$NUTS_Summary$Comp,
                             max(val$NUTS_Summary$statistics$ess_by_coda[1:100])/val$NUTS_Summary$Comp,
                             val$NUTS_Summary$statistics$ess_by_mcmcse[101]/val$NUTS_Summary$Comp,
                             val$NUTS_Summary$statistics$ess_by_coda[101]/val$NUTS_Summary$Comp,
    ...
    MetriceHMC[[k]][m,] <- c(min(val$eHMC_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMC_Summary$Comp,
                             mean(val$eHMC_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMC_Summary$Comp,
                             median(val$eHMC_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMC_Summary$Comp,
                             max(val$eHMC_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMC_Summary$Comp,
                             min(val$eHMC_Summary$statistics$ess_by_coda[1:100])/val$eHMC_Summary$Comp,
                             mean(val$eHMC_Summary$statistics$ess_by_coda[1:100])/val$eHMC_Summary$Comp,
                             median(val$eHMC_Summary$statistics$ess_by_coda[1:100])/val$eHMC_Summary$Comp,
                             max(val$eHMC_Summary$statistics$ess_by_coda[1:100])/val$eHMC_Summary$Comp,
                             val$eHMC_Summary$statistics$ess_by_mcmcse[101]/val$eHMC_Summary$Comp,
                             val$eHMC_Summary$statistics$ess_by_coda[101]/val$eHMC_Summary$Comp,
    ...
    MetriceHMCq[[k]][m,] <- c(min(val$eHMCq_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMCq_Summary$Comp,
                              mean(val$eHMCq_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMCq_Summary$Comp,
                              median(val$eHMCq_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMCq_Summary$Comp,
                              max(val$eHMCq_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMCq_Summary$Comp,
                              min(val$eHMCq_Summary$statistics$ess_by_coda[1:100])/val$eHMCq_Summary$Comp,
                              mean(val$eHMCq_Summary$statistics$ess_by_coda[1:100])/val$eHMCq_Summary$Comp,
                              median(val$eHMCq_Summary$statistics$ess_by_coda[1:100])/val$eHMCq_Summary$Comp,
                              max(val$eHMCq_Summary$statistics$ess_by_coda[1:100])/val$eHMCq_Summary$Comp,
                              val$eHMCq_Summary$statistics$ess_by_mcmcse[101]/val$eHMCq_Summary$Comp,
                              val$eHMCq_Summary$statistics$ess_by_coda[101]/val$eHMCq_Summary$Comp,
    ...
    MetriceHMCu[[k]][m,] <- c(min(val$eHMCu_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMCu_Summary$Comp,
                              mean(val$eHMCu_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMCu_Summary$Comp,
                              median(val$eHMCu_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMCu_Summary$Comp,
                              max(val$eHMCu_Summary$statistics$ess_by_mcmcse[1:100])/val$eHMCu_Summary$Comp,
                              min(val$eHMCu_Summary$statistics$ess_by_coda[1:100])/val$eHMCu_Summary$Comp,
                              mean(val$eHMCu_Summary$statistics$ess_by_coda[1:100])/val$eHMCu_Summary$Comp,
                              median(val$eHMCu_Summary$statistics$ess_by_coda[1:100])/val$eHMCu_Summary$Comp,
                              max(val$eHMCu_Summary$statistics$ess_by_coda[1:100])/val$eHMCu_Summary$Comp,
                              val$eHMCu_Summary$statistics$ess_by_mcmcse[101]/val$eHMCu_Summary$Comp,
                              val$eHMCu_Summary$statistics$ess_by_coda[101]/val$eHMCu_Summary$Comp,
...
ggplot(data=ESSTransformed,mapping=aes(x=x,y=y)) + 
  ...
  facet_grid(cols = vars(factor(Sampler))) + xlab("Desired accept probability: "~delta) + 
  ylab("ESS per gradient") + 
  ggtitle("MVN: Median ESS of" ~theta) +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_y_continuous(labels = function(x) format(x, scientific = TRUE, digits=3)) + 
  ylim(c(0,0.0025))
...
ggplot(data=ESSTransformed,mapping=aes(x=x,y=y)) + 
  ...
  geom_line(data=ESSSummary, mapping=aes(x=x, y=y), color="red", size=1) +
  facet_grid(cols = vars(factor(Sampler))) + xlab("Desired accept probability: "~delta) + 
  ylab(expression(h- delta)) + 
  ggtitle("MVN: Integration Time") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_y_continuous(labels = function(x) format(x, scientific = TRUE, digits=3)) +
  ylim(c(0,20))
