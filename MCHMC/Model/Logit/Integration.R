...
MixSampler <- function(k)
{
  ...
  fit1 <- eHMC( fit0$L_emp,epsilon0,M0,init0,d,1.45e4,feature_names0,U,grad_U,Leapfrog)
  fit2 <- eHMCq(fit0$L_emp,epsilon0,M0,init0,d,2e4,feature_names0,U,grad_U,Leapfrog)
  fit3 <- eHMCu(fit0$L_emp,epsilon0,M0,init0,d,2.6e4,feature_names0,U,grad_U,Leapfrog)
  
  fit4 <- CVHMC(eta=0.1, fit0$L_emp,epsilon0,M0,init0,d,5.2e4,feature_names0,U,grad_U,Leapfrog_dense)
